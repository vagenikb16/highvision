...
function generateBackstageGrid() {
  ...
  if (window.innerWidth <= 768) {
    let out = '';
    out += `<div class="backstage-video-full"><iframe src="https://www.youtube.com/embed/${vIds[0]}?autoplay=1&mute=1&loop=1&playlist=${vIds[0]}&controls=0&modestbranding=1&rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen title="backstage-video-1"></iframe></div>`;
    for (let i = 1; i <= 6; i++) out += `<div class="backstage-item small-p"><img src="${import.meta.env.BASE_URL}foto/${i}.jpg" loading="lazy"></div>`;
    out += `<div class="backstage-video-full"><iframe src="https://www.youtube.com/embed/${vIds[1]}?autoplay=1&mute=1&loop=1&playlist=${vIds[1]}&controls=0&modestbranding=1&rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen title="backstage-video-2"></iframe></div>`;
